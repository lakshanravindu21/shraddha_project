...
const rightNavItemsDesign =
    <>
        <button className='font-[16px] flex text-black items-center py-2'>
                ...
                <div className="relative flex h-16 items-center justify-between align-middle">
                    ...
                    <div className="flex flex-1 items-center sm:items-stretch justify-start my-auto">
                        <div className="flex shrink-0 items-center">
                            ...
                            <h5 className='text-[32px] font-semibold text-black'>Logo</h5>
                        </div>
                                    ...
                                    <div key={item.name} className="flex flex-col items-center">
                                        <a
                                            ...
                                            className={classNames(
                                                ...
                                                'rounded-md py-2 font-medium text-[16px] flex flex-col items-center',
                                            )}
                                        >
                                            {item.name}
                                            <span
                    ...
                    <div className=" inset-y-0 left-0 flex items-center justify-end md:hidden">
                        {/* Mobile menu button*/}
                        <DisclosureButton className="group relative inline-flex items-center justify-center rounded-md p-2 text-black hover:bg-black/5 focus:outline-2 focus:-outline-offset-1 focus:outline-indigo-500">
                    ...
                    <div className="hidden lg:flex justify-center gap-5 text-black items-center">
                        {rightNavItemsDesign}
                    </div>
