    ...
    return (
        <section className="p-4 sm:p-6 lg:p-8 my-8 max-w-[1641px] mx-auto w-full">
            ...
            <div className="relative flex items-center justify-center lg:mt-10">
                ...
                {/* Cards */}
                <div className="flex flex-col sm:flex-row gap-15 w-full justify-center">
                    {feedbacks.map((fb, idx) => (
                        <div key={idx} className="bg-[#F8F8F8] rounded-[24px] shadow-sm p-6 flex flex-col sm:flex-row items-center sm:items-start w-full sm:w-[350px] lg:w-[450px] min-h-[260px]">
